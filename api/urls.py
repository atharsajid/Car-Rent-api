...
urlpatterns = [
    ...
    path("car/", views.ListUserAPIView.as_view(), name="car_list"),
    path("car/create/", views.CreateUserAPIView.as_view(), name="car_create"),
    path("car/update/<int:pk>/",
         views.UpdateUserAPIView.as_view(), name="car_update"),
